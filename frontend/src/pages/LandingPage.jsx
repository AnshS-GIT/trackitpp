                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
                            ...
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                Onboard team members via invite codes. Manage roles per organization.
                            </p>
                        </div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                Generate invite codes to add team members. Assign roles to control who can manage, contribute, or audit.
                            </p>
                        </div>
